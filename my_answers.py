...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        self.activation_function = (lambda x:  1 / (1 + np.exp(-x)),
		                            lambda x: x * (1- x))  # Replace 0 with your sigmoid calculation.
    ...
    def forward_pass_train(self, X):
        ...
        hidden_outputs = self.activation_function[0](hidden_inputs)  # signals from hidden layer
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        hidden_error_term = hidden_error * self.activation_function[1](hidden_outputs)
